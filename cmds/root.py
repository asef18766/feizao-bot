...
from pics.handler import (get_pics, pics_resp)
from sticky_note.handler import (add_rem, remove_rem, list_rem)
...
class FeizaoRoot():
    ...
    def cmd_給我變(self, event, cmd_line):
        self.line_bot_api.reply_message(
            event.reply_token,
            pics_resp(get_pics("transform")),
        )
